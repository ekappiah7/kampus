...
/**
 * Access-code redemption for staff. The holder confirms the code is theirs, then
 * sets their own password. Two steps on purpose — showing "Welcome, <name>" before
...
export default function RedeemPage() {
  ...
  async function lookup(e: React.FormEvent) {
    ...
    try {
      ...
      if (found.audience !== "staff") {
        setError("That code belongs to a parent. Please use the Parent App instead.");
        return;
      }
